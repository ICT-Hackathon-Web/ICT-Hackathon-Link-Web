<template>
  <div class="main-container">
    ...
    <section class="hero-section">
      ...
      <div class="hero-text">
        <h1>Suwon University</h1>
        <p>Forward-thinking creative leadership, Compassionate leadership that considers the times</p>
      </div>
    </section>

    <!-- ✅ 2. 스크롤 시 고정되는 헤더 영역 -->
    <header :class="['header', { 'sticky': isSticky }]" @mouseleave="hideAllDropdowns"
      @mouseenter="navHovered = true">
      <img
        src="https://www.suwon.ac.kr/usr/images/suwon/logo.png"
        class="logo"
        @click="navigateTo('Main')" style="padding: 1.3rem 2rem"
      />
      <nav>
        <!-- 대학 안내 -->
